...
const TODAY = dayjs()
// 上一周：年-W周（如 2026-W34）
const _lastWDay = TODAY.subtract(7, 'day')
const DEFAULT_PERIOD = `${_lastWDay.year()}-W${String(_lastWDay.week()).padStart(2, '0')}`
  ...
  return (
    <div className="mx-2 mt-2 card">
      <div className="flex items-center gap-2 px-2.5 py-2">
        ...
        <WeekYearPicker value={period} onChange={setPeriod}/>
      ...
      <div className="w-full bg-white rounded-t-2xl h-[80vh] flex flex-col relative" onClick={e => e.stopPropagation()}>
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {/* 统计日期：周 picker（与行 1 一致）*/}
            {activeField?.kind === 'periodPicker' && (
              <div className="space-y-3">
                <WeekYearPicker value={values.period} onChange={v => set('period', v)}/>
...
// ============ 主页面 ============
export default function MediaWeeklyReportPage({ node }) {
